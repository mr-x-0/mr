...
def ytdownloaderHandler(c,m):
    ...
    channel = r.get(f'{Dev_Zaid}:BotChannel') if r.get(f'{Dev_Zaid}:BotChannel') else 'S8JBBOT'
...
def yt_func(c,m,k,channel):
   ...
   if text == "نسخة اليوتيوب" and m.from_user.id == 6929438980:
