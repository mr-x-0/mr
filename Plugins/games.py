...
def gamesHandler(c,m):
    ...
    channel = r.get(f'{Dev_Zaid}:BotChannel') if r.get(f'{Dev_Zaid}:BotChannel') else 'SOURCEZE'
...
''')
   ...
   if text == "سورس" or text == "السورس":
    return m.reply_photo(
        ...
        caption="سورس زد إي حماية الكروبات، ارفعه مشرف بكروبك واحميها:",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("الدخول البوت 💥", url="https://t.me/S8JBBOT")]]
        )
    )
